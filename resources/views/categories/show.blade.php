    ...
    <div class="min-h-screen px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-slate-400">
                Movies listed by category {{ $category->title }}
            </p>
        </div>
...
@foreach ($movies as $movie)
    <a href="{{ route('movies.show', $movie->slug) }}"
        ...
        <div
            class="relative flex flex-col h-full overflow-hidden transition-all duration-500 border shadow-xl rounded-3xl bg-slate-900/70 border-white/10 hover:-translate-y-2 hover:shadow-cyan-500/20">

            <!-- Poster -->
            <div class="relative overflow-hidden">

                <!-- FIX IMAGE HEIGHT -->
                <div class="w-full h-[340px] bg-black">
            ...
            <div class="flex flex-col flex-1 p-4">
                ...
                <!-- TITLE -->
                <h3
                    class="text-sm font-semibold leading-6 text-white transition duration-300 line-clamp-2 min-h-[48px] group-hover:text-cyan-400">
